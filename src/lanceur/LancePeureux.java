...
import client.StrategiePeureux;
...
public class LancePeureux {
	private static String usage = "USAGE : java " + LancePeureux.class.getName() + " [ port [ ipArene ] ]";
	...
	public static void main(String[] args) {
		...
		try {
			...
			new StrategiePeureux(ipArene, port, ipConsole, nom, groupe, caracts, nbTours, position, logger);
