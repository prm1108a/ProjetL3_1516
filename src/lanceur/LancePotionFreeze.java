...
public class LancePotionFreeze {
	...
	private static String usage = "USAGE : java " + LancePotionFreeze.class.getName() + " [ port [ ipArene ] ]";
	...
	public static void main(String[] args) {
		...
		try {
			logger = new LoggerProjet(true, "potion_freeze_"+nom+groupe);
		} catch (IOException e) {
			e.printStackTrace();
		...
		try {
			...
			logger.info("Lanceur", "Lancement de la potion freeze sur le serveur...");
			...
			// ajout de la potion
			arene.ajoutePotion(new PotionFreeze(nom, groupe, caractsPotion), Calculs.positionAleatoireArene());
			logger.info("Lanceur", "Lancement de la potion freeze reussi");
